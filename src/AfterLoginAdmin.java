    ...
    public void connect()
{
    ...
    private void initComponents() {
        ...
        jRadioButton1.setFont(new java.awt.Font("Dialog", 0, 24));
        jRadioButton1.setText("Complaint Inbox");
        ...
        setBounds((screenSize.width-930)/2, (screenSize.height-688)/2, 930, 688);
    }// </editor-fold>//GEN-END:initComponents

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        
        ChangePasswordAdmin cp=new  ChangePasswordAdmin(this,true);
        cp.checkPassword(depid);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            dispose();
            ViewComplaintAdmin ci=new ViewComplaintAdmin();
            ci.setVisible(true);
            ci.enroll(depid,depname);
